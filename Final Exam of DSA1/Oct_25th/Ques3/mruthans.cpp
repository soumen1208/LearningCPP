...
#define raj ios_base::sync_with_stdio(false)
 
#define ll long long int

#define j(x) scanf("%lld",&x)
#define j2(x,y) j(x)+j(y)
#define j3(x,y,z) j(x)+j(y)+j(z)
 
#define k(x) printf("%lld\n",x)
#define k2(x,y) k(x)+k(y)
#define k3(x,y,z) k(x)+k(y)+k(z)
...
ll inf = 1e18;
ll mod = 1e9 + 7 ;
ll m(ll a , ll b){return b==0?a:m(b,a%b);}
